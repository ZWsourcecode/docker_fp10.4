...
! GFS
   integer,parameter :: nxmax=361,nymax=281,nuvzmax=138,nwzmax=138,nzmax=138 ! ZW, nymax from 181 to 281, nuvzmax change 138 to 93
...
!  integer,parameter :: maxnests=0,nxmaxn=0,nymaxn=0
  integer,parameter :: maxnests=1,nxmaxn=361,nymaxn=351 ! ZW
  ...
  integer,parameter :: maxpart=100000000
