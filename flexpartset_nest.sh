...
# ======================================
input=$1 # meteo global input path
...
============================================
EOM
echo pathnames is done, under $HOME_PATH/
echo

# ======================================
# make RELEASES file
# ======================================
cat <<EOM >$OPTION_PATH/RELEASES
***************************************************************************************************************
*                                                                                                             *
*                                                                                                             *
*                                                                                                             *
...
echo RELEASES file is done, under $OPTION_PATH/. i.e. $((- $i / $step  )) releases from $start to $end. 
echo
...
echo COMMAND file is done, under $OPTION_PATH/.  
echo
...
echo OUTGRID file is done, under $OPTION_PATH/.
echo
...
cat <<EOM >$OPTION_PATH/OUTGRID_NEST
!*******************************************************************************
!                                                                              *
!      Input file for the Lagrangian particle dispersion model FLEXPART        *
!                       Please specify your output grid                        *
...
echo OUTGRID_NEST file is done, under $OPTION_PATH/.
echo
